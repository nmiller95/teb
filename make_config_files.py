...
def make_config(filename):
    ...
    with open(f'config/{filename}.yaml', 'w') as c:
        ...
        c.write('model_sed: bt-settl           # Which model SEDs to use (bt-settl, bt-settl-cifist, coelho-sed)\n')
        ...
        c.write('                              # 1 = single distortion function for both stars (not recommended)\n')
        ...
        c.write('apply_ebv_prior: True         # Put a prior on E(B-V) based on the provided value and error?\n')
        ...
        c.write('show_plots: True              # Whether to generate convergence, corner and final SED plots\n')
        ...
        c.write('                              # in corner plot (recommended for large values of \'n_coeffs\')\n')
        c.write('\n')
        c.write('\n')
